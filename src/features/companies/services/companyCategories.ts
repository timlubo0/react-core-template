...
export const companyCategoriesService = {
  create: (payLoad: ICompanyCategory): Promise<PostPutResponse<ICompanyCategory>> =>
  ...
  update: (payLoad: ICompanyCategory, uid: string): Promise<PostPutResponse<ICompanyCategory>> =>
    api.post({ endPoint: `${endPoints.companyCategories}/${uid}`, data: payLoad, method: "PUT" }),
  delete: (uid: string): Promise<PostPutResponse<ICompanyCategory>> =>
    api.get({ endPoint: `${endPoints.companyCategories}/${uid}`, method: "DELETE" }),
};